...
const useAnimation = (ball, logo, logoName, copyright, name, currentIndex, initialized, indexPage) => {
    ...
    useEffect(() => {
      ...
      if (currentIndex !== 0) {
        ...
        // gsap.to(
        //   logoName.current.querySelector('img'),
        //   {
        //     transform: 'scale(32.5) translate(-45.75%, -36%)',
        //     duration: 2,
        //   }
        // )
      }
